...
function PartnerDetails({type}) {
    const [detailsType, setDetailsType] = useState("personal");
    const [gender, setGender] = useState("");
    const[alive,setAlive] = useState("Y")
    const bloodGroup = [
    ...
    return (
            <div>
                ...
                <div className="display-flex mb-1p">
                    ...
                    <Input iconPosition='left' className="mx-5p" label="WhatsApp" placeholder='Phone no.'/>
