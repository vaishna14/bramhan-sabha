  ...
  _createClass(ArraySizePredictor, [{
    ...
    value: function checkArraySizeForFunction(ast, state) {
      ...
      var subChecks = ast.args.map(function (arg) {
        ...
        return _this.checkArraySizeForAst(arg, new _InterpreterState.InterpreterState(state.formulaAddress, state.arraysFlag || ((_a = metadata === null || metadata === void 0 ? void 0 : metadata.arrayFunction) !== null && _a !== void 0 ? _a : false)));
      });
